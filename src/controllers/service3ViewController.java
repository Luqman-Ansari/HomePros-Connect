...
public class service3ViewController  {
    @FXML
    ...
    @FXML
    private TableView<service3ViewController.ResultModel> resultTableView;
    @FXML
    private TableColumn<service3ViewController.ResultModel, String> serviceNameCol;
    @FXML
    private TableColumn<service3ViewController.ResultModel, String> customerNameCol;
    @FXML
    private TableColumn<service3ViewController.ResultModel, Float> amountCol;
    @FXML
    private TableColumn<service3ViewController.ResultModel, String> paidCol;
    @FXML
    private TableColumn<service3ViewController.ResultModel, String> feedbackCol;
    ...
    private class ResultModel{
        ...
        public ResultModel(String s1, String s2, float s3, boolean s4, String s5)
        {
            serviceName = s1;
            customerName = s2;
            amount = s3;
    ...
    public void initialize() {
        ...
        if(userID!=null) {
            ...
            try {
                ResultSet resultSet = provider.getServicesCompleted();
                int count = 0;
                while (resultSet.next()) {
                    if (!resultSet.isClosed()) {
                        service3ViewController.ResultModel data = new service3ViewController.ResultModel(
                                resultSet.getString("ServiceName"),
                                resultSet.getString("CustomerName"),
                                resultSet.getFloat("amount"),
                                resultSet.getBoolean("PaidStatus"),
                ...
                amountCol.setCellValueFactory(cellData -> {
                    float amountValue = cellData.getValue().amount;
                ...
                paidCol.setCellValueFactory(cellData -> {
                    boolean isPaid = cellData.getValue().paid;
                    return new SimpleStringProperty(isPaid ? "Paid" : "Not Paid");
                });
